...
class CaltrainTrip {
  ...
  */
  setService () {
    const mins = CaltrainService.tripStops(this.trip, this.direction, this.schedule)
    const strs = (this.direction === 'North') ? caltrainServiceData.northStops : caltrainServiceData.southStops
    this.times = []
    this.stops = []
    // populate instance
